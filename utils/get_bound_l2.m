function [UB, LB] = get_bound_l2(W,b,Image,Radius,DoPrint)
...
for l = 1:ell
    ...
    parfor pdx = 1:workers
        ...
        for batch = 1:batchs
            Cost = Cpar(batch,:)';
            [~,pub(batch)] = lp_full_l2(Weight, Bias, -Cost, Image, Radius, Params);
            [~,plb(batch)] = lp_full_l2(Weight, Bias,  Cost, Image, Radius, Params);
